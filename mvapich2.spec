...
Source230:  http://mvapich.cse.ohio-state.edu/download/mvapich/mv2/%{name}-2.3.tar.gz
...
%changelog
* Thu Sep 06 2018 Jarod Wilson <jarod@redhat.com> - 2.2-4
- Use only --with-pic=yes, see if that's the magic
- Related: #1625672

* Wed Sep 05 2018 Jarod Wilson <jarod@redhat.com> - 2.2-3
- Use ./configure --with-pic for even more PIC fixes
- Related: #1625672

* Wed Sep 05 2018 Jarod Wilson <jarod@redhat.com> - 2.2-2
- Add further -fPIC fixes
- Related: #1625672

* Tue Sep 04 2018 Jarod Wilson <jarod@redhat.com> - 2.2-1.5
- Update mvapich23 (TrueScale) bits to 2.3 release
- Fix libmpi.a being built w/o -fPIC
- Resolves: #1625672
