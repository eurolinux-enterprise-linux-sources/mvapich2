...
int main(int argc, char **argv)
{
    ...
    /* src/mpi/topo/graphcreate.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**nulledge", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**nulledge" );
    {
    /* src/mpi/topo/graphcreate.c */
    int i1 = 1;
    int i2 = 2;
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**nulledge", "**nulledge %d %d", i1, i2 );
    ChkMsg( err, MPI_ERR_OTHER, "**nulledge %d %d" );
    }
    ...
    /* src/mpi/romio/adio/ad_pvfs/ad_pvfs_read.c */
    ...
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**init", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**init" );
    /* src/mpi/init/initthread.c */
    ...
    /* src/nameserv/pmi/pmi_nameserv.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**pmi_kvs_destroy", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**pmi_kvs_destroy" );
    ...
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**fdopen", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**fdopen" );
    {
    /* src/util/dbg/dbg_printf.c */
    char s1[] = "string1";
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**fdopen", "**fdopen %s", s1 );
    ChkMsg( err, MPI_ERR_OTHER, "**fdopen %s" );
    }
    /* src/util/dbg/dbg_printf.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**tmpnam", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**tmpnam" );
    {
    /* src/util/dbg/dbg_printf.c */
    char s1[] = "string1";
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**tmpnam", "**tmpnam %s", s1 );
    ChkMsg( err, MPI_ERR_OTHER, "**tmpnam %s" );
    }
    /* src/util/dbg/dbg_printf.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**fopen", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**fopen" );
    {
    /* src/util/dbg/dbg_printf.c */
    char s1[] = "string1";
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**fopen", "**fopen %s", s1 );
    ChkMsg( err, MPI_ERR_OTHER, "**fopen %s" );
    }
    ...
    {
    /* src/mpid/ch3/util/shmproc/shmproc.c */
    char s1[] = "string1";
    int i2 = 2;
    int i3 = 3;
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**open", "**open %s %d %d", s1, i2, i3 );
    ChkMsg( err, MPI_ERR_OTHER, "**open %s %d %d" );
    }
    {
    /* src/mpid/ch3/util/shmproc/shmproc.c */
    char s1[] = "string1";
    ...
    /* src/mpid/ch3/util/shmproc/shmproc.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**OpenProcess", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**OpenProcess" );
    {
    /* src/mpid/ch3/util/shmproc/shmproc.c */
    int i1 = 1;
    int i2 = 2;
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**OpenProcess", "**OpenProcess %d %d", i1, i2 );
    ChkMsg( err, MPI_ERR_OTHER, "**OpenProcess %d %d" );
    }
    ...
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**shmq_index", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**shmq_index" );
    {
    /* src/mpid/ch3/util/shmbase/ch3_shm.c */
    int i1 = 1;
    int i2 = 2;
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**shmq_index", "**shmq_index %d %d", i1, i2 );
    ChkMsg( err, MPI_ERR_OTHER, "**shmq_index %d %d" );
    }
    /* src/mpid/ch3/util/shmbase/ch3_shm.c */
    ...
    /* src/mpid/ch3/util/shmbase/ch3_shm.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**pkt_ptr", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**pkt_ptr" );
    {
    /* src/mpid/ch3/util/shmbase/ch3_shm.c */
    char s1[] = "pointer1";
    char s2[] = "pointer2";
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**pkt_ptr", "**pkt_ptr %p %p", s1, s2 );
    ChkMsg( err, MPI_ERR_OTHER, "**pkt_ptr %p %p" );
    }
    /* src/mpid/ch3/util/shmbase/ch3_shm.c */
    ...
    /* src/mpid/ch3/util/shm/ch3u_init_sshm.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**boot_create", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**boot_create" );
    {
    /* src/mpid/ch3/util/shm/ch3u_init_sshm.c */
    int i1 = 1;
    ...
    /* src/mpid/ch3/util/shm/ch3u_init_sshm.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**node_root_rank", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**node_root_rank" );
    /* src/mpid/ch3/util/shm/ch3u_init_sshm.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**boot_unlink", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**boot_unlink" );
    /* src/mpid/ch3/util/shm/ch3u_init_sshm.c */
    ...
    /* src/mpid/ch3/util/shm/ch3u_init_sshm.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**pmi_invalid_clique_size", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**pmi_invalid_clique_size" );
    {
    /* src/mpid/ch3/util/shm/ch3u_init_sshm.c */
    int i1 = 1;
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**pmi_invalid_clique_size", "**pmi_invalid_clique_size %d", i1 );
    ChkMsg( err, MPI_ERR_OTHER, "**pmi_invalid_clique_size %d" );
    }
    /* src/mpid/ch3/util/shm/ch3u_init_sshm.c */
    ...
    /* src/mpid/ch3/util/shm/ch3i_shm_bootstrapq.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**ftruncate", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**ftruncate" );
    {
    /* src/mpid/ch3/util/shm/ch3i_shm_bootstrapq.c */
    char s1[] = "string1";
    int i2 = 2;
    int i3 = 3;
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**ftruncate", "**ftruncate %s %d %d", s1, i2, i3 );
    ChkMsg( err, MPI_ERR_OTHER, "**ftruncate %s %d %d" );
    }
    /* src/mpid/ch3/util/shm/ch3i_shm_bootstrapq.c */
    ...
    /* src/mpid/ch3/util/shm/ch3i_shm_bootstrapq.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**shmget", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**shmget" );
    {
    /* src/mpid/ch3/util/shm/ch3i_shm_bootstrapq.c */
    int i1 = 1;
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**shmget", "**shmget %d", i1 );
    ChkMsg( err, MPI_ERR_OTHER, "**shmget %d" );
    }
    /* src/mpid/ch3/util/shm/ch3i_shm_bootstrapq.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**CreateFileMapping", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**CreateFileMapping" );
    {
    /* src/mpid/ch3/util/shm/ch3i_shm_bootstrapq.c */
    int i1 = 1;
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**CreateFileMapping", "**CreateFileMapping %d", i1 );
    ChkMsg( err, MPI_ERR_OTHER, "**CreateFileMapping %d" );
    }
    /* src/mpid/ch3/util/shm/ch3i_shm_bootstrapq.c */
    ...
    /* src/mpid/ch3/util/shm/ch3i_shm_bootstrapq.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**shmat", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**shmat" );
    {
    /* src/mpid/ch3/util/shm/ch3i_shm_bootstrapq.c */
    int i1 = 1;
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**shmat", "**shmat %d", i1 );
    ChkMsg( err, MPI_ERR_OTHER, "**shmat %d" );
    }
    /* src/mpid/ch3/util/shm/ch3i_shm_bootstrapq.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**MapViewOfFileEx", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**MapViewOfFileEx" );
    {
    /* src/mpid/ch3/util/shm/ch3i_shm_bootstrapq.c */
    int i1 = 1;
    ...
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**mqshm_create", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**mqshm_create" );
    /* src/mpid/ch3/util/shm/ch3i_bootstrapq.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**msgget", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**msgget" );
    {
    /* src/mpid/ch3/util/shm/ch3i_bootstrapq.c */
    int i1 = 1;
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**msgget", "**msgget %d", i1 );
    ChkMsg( err, MPI_ERR_OTHER, "**msgget %d" );
    }
    /* src/mpid/ch3/util/shm/ch3i_bootstrapq.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**mq_open", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**mq_open" );
    {
    /* src/mpid/ch3/util/shm/ch3i_bootstrapq.c */
    int i1 = 1;
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**mq_open", "**mq_open %d", i1 );
    ChkMsg( err, MPI_ERR_OTHER, "**mq_open %d" );
    }
    /* src/mpid/ch3/util/shm/ch3i_bootstrapq.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**CreateThread", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**CreateThread" );
    {
    /* src/mpid/ch3/util/shm/ch3i_bootstrapq.c */
    int i1 = 1;
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**CreateThread", "**CreateThread %d", i1 );
    ChkMsg( err, MPI_ERR_OTHER, "**CreateThread %d" );
    }
    /* src/mpid/ch3/util/shm/ch3i_bootstrapq.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**winwait", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**winwait" );
    /* src/mpid/ch3/util/shm/ch3i_bootstrapq.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**mq_close", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**mq_close" );
    {
    /* src/mpid/ch3/util/shm/ch3i_bootstrapq.c */
    int i1 = 1;
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**mq_close", "**mq_close %d", i1 );
    ChkMsg( err, MPI_ERR_OTHER, "**mq_close %d" );
    }
    /* src/mpid/ch3/util/shm/ch3i_bootstrapq.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**msgctl", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**msgctl" );
    {
    /* src/mpid/ch3/util/shm/ch3i_bootstrapq.c */
    int i1 = 1;
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**msgctl", "**msgctl %d", i1 );
    ChkMsg( err, MPI_ERR_OTHER, "**msgctl %d" );
    }
    /* src/mpid/ch3/util/shm/ch3i_bootstrapq.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**FindWindowEx", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**FindWindowEx" );
    {
    /* src/mpid/ch3/util/shm/ch3i_bootstrapq.c */
    int i1 = 1;
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**FindWindowEx", "**FindWindowEx %d", i1 );
    ChkMsg( err, MPI_ERR_OTHER, "**FindWindowEx %d" );
    }
    /* src/mpid/ch3/util/shm/ch3i_bootstrapq.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**mqshm_send", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**mqshm_send" );
    /* src/mpid/ch3/util/shm/ch3i_bootstrapq.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**bootqmsg", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**bootqmsg" );
    {
    /* src/mpid/ch3/util/shm/ch3i_bootstrapq.c */
    int i1 = 1;
    int i2 = 2;
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**bootqmsg", "bootqmsg %d %d", i1, i2 );
    ChkMsg( err, MPI_ERR_OTHER, "bootqmsg %d %d" );
    }
    /* src/mpid/ch3/util/shm/ch3i_bootstrapq.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**mq_send", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**mq_send" );
    {
    /* src/mpid/ch3/util/shm/ch3i_bootstrapq.c */
    int i1 = 1;
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**mq_send", "**mq_send %d", i1 );
    ChkMsg( err, MPI_ERR_OTHER, "**mq_send %d" );
    }
    /* src/mpid/ch3/util/shm/ch3i_bootstrapq.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**msgsnd", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**msgsnd" );
    {
    /* src/mpid/ch3/util/shm/ch3i_bootstrapq.c */
    int i1 = 1;
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**msgsnd", "**msgsnd %d", i1 );
    ChkMsg( err, MPI_ERR_OTHER, "**msgsnd %d" );
    }
    /* src/mpid/ch3/util/shm/ch3i_bootstrapq.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**mqshm_receive", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**mqshm_receive" );
    /* src/mpid/ch3/util/shm/ch3i_bootstrapq.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**mq_receive", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**mq_receive" );
    {
    /* src/mpid/ch3/util/shm/ch3i_bootstrapq.c */
    int i1 = 1;
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**mq_receive", "**mq_receive %d", i1 );
    ChkMsg( err, MPI_ERR_OTHER, "**mq_receive %d" );
    }
    /* src/mpid/ch3/util/shm/ch3i_bootstrapq.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**msgrcv", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**msgrcv" );
    {
    /* src/mpid/ch3/util/shm/ch3i_bootstrapq.c */
    int i1 = 1;
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**msgrcv", "**msgrcv %d", i1 );
    ChkMsg( err, MPI_ERR_OTHER, "**msgrcv %d" );
    }
    /* src/mpid/ch3/util/shm/ch3i_bootstrapq.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**nextbootmsg", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**nextbootmsg" );
    ...
    int i1 = 1;
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**nomem", "**nomemuereq %d", i1 );
    ...
    /* src/mpid/ch3/src/ch3u_rma_sync.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**ch3|rmarndvmsg", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**ch3|rmarndvmsg" );
    /* src/mpid/ch3/src/ch3u_rma_sync.c */
    ...
    /* src/mpid/ch3/src/ch3u_rma_sync.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**winRMArequest", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**winRMArequest" );
    /* src/mpid/ch3/src/ch3u_rma_sync.c */
    ...
    /* src/mpid/ch3/src/ch3u_rma_sync.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**ch3|rndv", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**ch3|rndv" );
    ...
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**rdmacmmaxport", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**rdmacmmaxport" );
    {
    /* src/mpid/ch3/channels/common/src/rdma_cm/rdma_cm.c */
    int i1 = 1;
    int i2 = 2;
    int i3 = 3;
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**rdmacmmaxport", "**rdmacmmaxport %d %d %d", i1, i2, i3 );
    ChkMsg( err, MPI_ERR_OTHER, "**rdmacmmaxport %d %d %d" );
    }
    /* src/mpid/ch3/channels/common/src/rdma_cm/rdma_cm.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**rdmacmminport", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**rdmacmminport" );
    {
    /* src/mpid/ch3/channels/common/src/rdma_cm/rdma_cm.c */
    int i1 = 1;
    int i2 = 2;
    int i3 = 3;
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**rdmacmminport", "**rdmacmminport %d %d %d", i1, i2, i3 );
    ChkMsg( err, MPI_ERR_OTHER, "**rdmacmminport %d %d %d" );
    }
    /* src/mpid/ch3/channels/common/src/rdma_cm/rdma_cm.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**rdmacmportrange", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**rdmacmportrange" );
    {
    /* src/mpid/ch3/channels/common/src/rdma_cm/rdma_cm.c */
    int i1 = 1;
    int i2 = 2;
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**rdmacmportrange", "**rdmacmportrange %d %d", i1, i2 );
    ChkMsg( err, MPI_ERR_OTHER, "**rdmacmportrange %d %d" );
    }
    /* src/mpid/ch3/channels/common/src/rdma_cm/rdma_cm.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**rdmacminvalidport", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**rdmacminvalidport" );
    {
    /* src/mpid/ch3/channels/common/src/rdma_cm/rdma_cm.c */
    int i1 = 1;
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**rdmacminvalidport", "**rdmacminvalidport %d", i1 );
    ChkMsg( err, MPI_ERR_OTHER, "**rdmacminvalidport %d" );
    }
    {
    /* src/mpid/ch3/channels/common/src/rdma_cm/rdma_cm.c */
    char s1[] = "string1";
    char s2[] = "string2";
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**fail", "%s: %s", s1, s2 );
    ChkMsg( err, MPI_ERR_OTHER, "%s: %s" );
    }
    /* src/mpid/ch3/channels/mrail/src/gen2/rdma_iba_1sc.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**onesidedcomps", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**onesidedcomps" );
    {
    /* src/mpid/ch3/channels/mrail/src/gen2/ring_startup.c */
    char s1[] = "string1";
    int i2 = 2;
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**fail", "%s%d", s1, i2 );
    ChkMsg( err, MPI_ERR_OTHER, "%s%d" );
    }
    /* src/mpid/ch3/channels/mrail/src/gen2/ibv_param.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**ibv_get_device_name", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**ibv_get_device_name" );
    /* src/mpid/ch3/channels/mrail/src/gen2/ibv_param.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**ibv_query_device", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**ibv_query_device" );
    {
    /* src/mpid/ch3/channels/mrail/src/gen2/ibv_param.c */
    char s1[] = "string1";
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**ibv_query_device", "**ibv_query_device %s", s1 );
    ChkMsg( err, MPI_ERR_OTHER, "**ibv_query_device %s" );
    }
    {
    ...
    /* src/mpid/ch3/channels/mrail/src/gen2/rdma_iba_priv.c */
    int i1 = 1;
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**fail", "Failed to retrieve gid on rank %d", i1 );
    ChkMsg( err, MPI_ERR_OTHER, "Failed to retrieve gid on rank %d" );
    }
    /* src/mpid/ch3/channels/mrail/src/gen2/rdma_iba_priv.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**activeports", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**activeports" );
    {
    /* src/mpid/ch3/channels/mrail/src/gen2/rdma_iba_priv.c */
    int i1 = 1;
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**activeports", "**activeports %d", i1 );
    ChkMsg( err, MPI_ERR_OTHER, "**activeports %d" );
    }
    /* src/mpid/ch3/channels/mrail/src/gen2/rdma_iba_priv.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**portquery", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**portquery" );
    {
    /* src/mpid/ch3/channels/mrail/src/gen2/rdma_iba_priv.c */
    int i1 = 1;
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**portquery", "**portquery %d", i1 );
    ChkMsg( err, MPI_ERR_OTHER, "**portquery %d" );
    }
    /* src/mpid/ch3/channels/psm/src/psm_queue.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**psmsendcancel", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**psmsendcancel" );
    /* src/mpid/ch3/channels/psm/src/psm_entry.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**psminit", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**psminit" );
    /* src/mpid/ch3/channels/psm/src/psm_entry.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**psmepopen", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**psmepopen" );
    /* src/mpid/ch3/channels/psm/src/psm_entry.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**psmnomem", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**psmnomem" );
    /* src/mpid/ch3/channels/psm/src/psm_entry.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**psmconnectfailed", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**psmconnectfailed" );
    /* src/mpid/ch3/channels/psm/src/psm_entry.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**psm_mqinitfailed", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**psm_mqinitfailed" );
    /* src/mpid/ch3/channels/psm/src/psm_entry.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**epid_putfailed", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**epid_putfailed" );
    /* src/mpid/ch3/channels/psm/src/psm_entry.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**epid_putcommit", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**epid_putcommit" );
    /* src/mpid/ch3/channels/psm/src/psm_entry.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**epid_getfailed", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**epid_getfailed" );
    /* src/mpid/ch3/channels/psm/src/psm_entry.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**pmiputuuid", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**pmiputuuid" );
    /* src/mpid/ch3/channels/psm/src/psm_entry.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**pmicommituuid", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**pmicommituuid" );
    /* src/mpid/ch3/channels/psm/src/psm_entry.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**pmigetuuid", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**pmigetuuid" );
    ...
    /* src/mpid/ch3/channels/ssm/src/ch3_isend.c */
    ...
    /* src/mpid/ch3/channels/ssm/src/ch3_progress.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**shm_read_progress", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**shm_read_progress" );
    /* src/mpid/ch3/channels/ssm/src/ch3_progress.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**progress_handle_sock_op", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**progress_handle_sock_op" );
    /* src/mpid/ch3/channels/ssm/src/ch3_progress.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**boot_recv", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**boot_recv" );
    {
    /* src/mpid/ch3/channels/ssm/src/ch3_progress.c */
    int i1 = 1;
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**bootqmsg", "**bootqmsg %d", i1 );
    ChkMsg( err, MPI_ERR_OTHER, "**bootqmsg %d" );
    }
    /* src/mpid/ch3/channels/ssm/src/ch3_progress.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**attach_to_mem", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**attach_to_mem" );
    {
    /* src/mpid/ch3/channels/ssm/src/ch3_progress.c */
    int i1 = 1;
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**attach_to_mem", "**attach_to_mem %d", i1 );
    ChkMsg( err, MPI_ERR_OTHER, "**attach_to_mem %d" );
    }
    /* src/mpid/ch3/channels/ssm/src/ch3_progress.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**progress_test", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**progress_test" );
    /* src/mpid/ch3/channels/ssm/src/ch3_progress.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**handle_sock_op", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**handle_sock_op" );
    /* src/mpid/ch3/channels/ssm/src/ch3_progress.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**test_sock_wait", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**test_sock_wait" );
    /* src/mpid/ch3/channels/ssm/src/ch3_progress.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**mqp_failure", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**mqp_failure" );
    /* src/mpid/ch3/channels/ssm/src/ch3_progress.c */
    ...
    /* src/mpid/ch3/channels/ssm/src/ch3_progress.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**MPIDI_CH3I_SHM_Attach_to_mem", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**MPIDI_CH3I_SHM_Attach_to_mem" );
    {
    /* src/mpid/ch3/channels/ssm/src/ch3_progress.c */
    int i1 = 1;
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**MPIDI_CH3I_SHM_Attach_to_mem", "**MPIDI_CH3I_SHM_Attach_to_mem %d", i1 );
    ChkMsg( err, MPI_ERR_OTHER, "**MPIDI_CH3I_SHM_Attach_to_mem %d" );
    }
    /* src/mpid/ch3/channels/ssm/src/ch3_progress_shm.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**iov_offset", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**iov_offset" );
    {
    /* src/mpid/ch3/channels/ssm/src/ch3_progress_shm.c */
    int i1 = 1;
    int i2 = 2;
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**iov_offset", "**iov_offset %d %d", i1, i2 );
    ChkMsg( err, MPI_ERR_OTHER, "**iov_offset %d %d" );
    }
    ...
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**shm_unlink", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**shm_unlink" );
    {
    /* src/mpid/ch3/channels/ssm/src/ch3_shm_memory.c */
    char s1[] = "string1";
    int i2 = 2;
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**shm_unlink", "**shm_unlink %s %d", s1, i2 );
    ChkMsg( err, MPI_ERR_OTHER, "**shm_unlink %s %d" );
    }
    /* src/mpid/ch3/channels/ssm/src/ch3_shm_memory.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**shmctl", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**shmctl" );
    {
    /* src/mpid/ch3/channels/ssm/src/ch3_shm_memory.c */
    int i1 = 1;
    int i2 = 2;
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**shmctl", "**shmctl %d %d", i1, i2 );
    ChkMsg( err, MPI_ERR_OTHER, "**shmctl %d %d" );
    }
    ...
    /* src/mpid/ch3/channels/nemesis/nemesis/netmod/wintcp/wintcp_poll.c */
    ...
    /* src/mpid/ch3/channels/nemesis/nemesis/netmod/wintcp/wintcp_init.c */
    ...
    {
    /* src/mpid/ch3/channels/nemesis/nemesis/netmod/wintcp/socksm.c */
    char s1[] = "string1";
    ...
    /* src/mpid/ch3/channels/nemesis/nemesis/netmod/wintcp/wintcp_utility.c */
    ...
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**psm_connect", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**psm_connect" );
    {
    /* src/mpid/ch3/channels/nemesis/nemesis/netmod/psm/psm_send.c */
    int i1 = 1;
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**psm_connect", "**psm_connect %d", i1 );
    ChkMsg( err, MPI_ERR_OTHER, "**psm_connect %d" );
    }
    /* src/mpid/ch3/channels/nemesis/nemesis/netmod/psm/psm_send.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**psm_test", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**psm_test" );
    {
    /* src/mpid/ch3/channels/nemesis/nemesis/netmod/psm/psm_send.c */
    char s1[] = "string1";
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**psm_test", "**psm_test %s", s1 );
    ChkMsg( err, MPI_ERR_OTHER, "**psm_test %s" );
    }
    /* src/mpid/ch3/channels/nemesis/nemesis/netmod/psm/psm_send.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**psm_isend", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**psm_isend" );
    {
    /* src/mpid/ch3/channels/nemesis/nemesis/netmod/psm/psm_send.c */
    char s1[] = "string1";
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**psm_isend", "**psm_isend %s", s1 );
    ChkMsg( err, MPI_ERR_OTHER, "**psm_isend %s" );
    }
    /* src/mpid/ch3/channels/nemesis/nemesis/netmod/psm/psm_init.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**psm_init", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**psm_init" );
    {
    /* src/mpid/ch3/channels/nemesis/nemesis/netmod/psm/psm_init.c */
    char s1[] = "string1";
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**psm_init", "**psm_init %s", s1 );
    ChkMsg( err, MPI_ERR_OTHER, "**psm_init %s" );
    }
    /* src/mpid/ch3/channels/nemesis/nemesis/netmod/psm/psm_init.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**encode_buffer", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**encode_buffer" );
    {
    /* src/mpid/ch3/channels/nemesis/nemesis/netmod/psm/psm_init.c */
    int i1 = 1;
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**encode_buffer", "**encode_buffer %d", i1 );
    ChkMsg( err, MPI_ERR_OTHER, "**encode_buffer %d" );
    }
    /* src/mpid/ch3/channels/nemesis/nemesis/netmod/psm/psm_init.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**decode_buffer", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**decode_buffer" );
    {
    /* src/mpid/ch3/channels/nemesis/nemesis/netmod/psm/psm_init.c */
    int i1 = 1;
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**decode_buffer", "**decode_buffer %d", i1 );
    ChkMsg( err, MPI_ERR_OTHER, "**decode_buffer %d" );
    }
    /* src/mpid/ch3/channels/nemesis/nemesis/netmod/psm/psm_init.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**psm_ep_open", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**psm_ep_open" );
    {
    /* src/mpid/ch3/channels/nemesis/nemesis/netmod/psm/psm_init.c */
    char s1[] = "string1";
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**psm_ep_open", "**psm_ep_open %s", s1 );
    ChkMsg( err, MPI_ERR_OTHER, "**psm_ep_open %s" );
    }
    /* src/mpid/ch3/channels/nemesis/nemesis/netmod/psm/psm_init.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**psm_mq_init", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**psm_mq_init" );
    {
    /* src/mpid/ch3/channels/nemesis/nemesis/netmod/psm/psm_init.c */
    char s1[] = "string1";
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**psm_mq_init", "**psm_mq_init %s", s1 );
    ChkMsg( err, MPI_ERR_OTHER, "**psm_mq_init %s" );
    }
    /* src/mpid/ch3/channels/nemesis/nemesis/netmod/psm/psm_init.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**psm_ep_connect", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**psm_ep_connect" );
    {
    /* src/mpid/ch3/channels/nemesis/nemesis/netmod/psm/psm_init.c */
    char s1[] = "string1";
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**psm_ep_connect", "**psm_ep_connect %s", s1 );
    ChkMsg( err, MPI_ERR_OTHER, "**psm_ep_connect %s" );
    }
    /* src/mpid/ch3/channels/nemesis/nemesis/netmod/psm/psm_poll.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**psm_irecv", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**psm_irecv" );
    {
    /* src/mpid/ch3/channels/nemesis/nemesis/netmod/psm/psm_poll.c */
    char s1[] = "string1";
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**psm_irecv", "**psm_irecv %s", s1 );
    ChkMsg( err, MPI_ERR_OTHER, "**psm_irecv %s" );
    }
    /* src/mpid/ch3/channels/nemesis/nemesis/netmod/psm/psm_finalize.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**psm_mq_finalize", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**psm_mq_finalize" );
    {
    /* src/mpid/ch3/channels/nemesis/nemesis/netmod/psm/psm_finalize.c */
    char s1[] = "string1";
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**psm_mq_finalize", "**psm_mq_finalize %s", s1 );
    ChkMsg( err, MPI_ERR_OTHER, "**psm_mq_finalize %s" );
    }
    /* src/mpid/ch3/channels/nemesis/nemesis/netmod/psm/psm_finalize.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**psm_close_endpoint", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**psm_close_endpoint" );
    {
    /* src/mpid/ch3/channels/nemesis/nemesis/netmod/psm/psm_finalize.c */
    char s1[] = "string1";
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**psm_close_endpoint", "**psm_close_endpoint %s", s1 );
    ChkMsg( err, MPI_ERR_OTHER, "**psm_close_endpoint %s" );
    }
    /* src/mpid/ch3/channels/nemesis/nemesis/netmod/psm/psm_finalize.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**psm_finalize", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**psm_finalize" );
    {
    /* src/mpid/ch3/channels/nemesis/nemesis/netmod/psm/psm_finalize.c */
    char s1[] = "string1";
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**psm_finalize", "**psm_finalize %s", s1 );
    ChkMsg( err, MPI_ERR_OTHER, "**psm_finalize %s" );
    }
    ...
    /* src/mpid/ch3/channels/nemesis/nemesis/netmod/ib/ib_vc_init.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**ibv_create_ah", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**ibv_create_ah" );
    {
    /* src/mpid/ch3/channels/nemesis/nemesis/netmod/ib/ib_vc_init.c */
    char s1[] = "pointer1";
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**ibv_create_ah", "**ibv_create_ah %p", s1 );
    ChkMsg( err, MPI_ERR_OTHER, "**ibv_create_ah %p" );
    }
    /* src/mpid/ch3/channels/nemesis/nemesis/netmod/ib/ib_lmt_recv.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**nem|loadsendiov", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**nem|loadsendiov" );
    /* src/mpid/ch3/channels/nemesis/nemesis/netmod/ib/ib_lmt_recv.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**nem_ib|rndv", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**nem_ib|rndv" );
    /* src/mpid/ch3/channels/nemesis/nemesis/netmod/ib/ib_hca.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**umadinit", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**umadinit" );
    /* src/mpid/ch3/channels/nemesis/nemesis/netmod/ib/ib_hca.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**umadgetca", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**umadgetca" );
    /* src/mpid/ch3/channels/nemesis/nemesis/netmod/ib/ib_hca.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**umadgetrate", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**umadgetrate" );
    ...
    /* src/mpid/ch3/channels/shm/src/ch3_isend.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**shmwrite", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**shmwrite" );
    /* src/mpid/ch3/channels/shm/src/shm_memory.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**shmsize", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**shmsize" );
    {
    /* src/mpid/ch3/channels/shm/src/shm_memory.c */
    int i1 = 1;
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**shmsize", "**shmsize %d", i1 );
    ChkMsg( err, MPI_ERR_OTHER, "**shmsize %d" );
    }
    /* src/mpid/ch3/channels/shm/src/ch3_progress.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**handle_written", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**handle_written" );
    /* src/mpid/ch3/channels/shm/src/ch3_progress.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**shm_op", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**shm_op" );
    {
    /* src/mpid/ch3/channels/shm/src/ch3_progress.c */
    int i1 = 1;
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**shm_op", "**shm_op %d", i1 );
    ChkMsg( err, MPI_ERR_OTHER, "**shm_op %d" );
    }
    ...
    /* src/mpid/ch3/channels/shm/src/ch3_init.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**shmhost", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**shmhost" );
    {
    /* src/mpid/ch3/channels/shm/src/ch3_init.c */
    char s1[] = "string1";
    char s2[] = "string2";
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**shmhost", "**shmhost %s %s", s1, s2 );
    ChkMsg( err, MPI_ERR_OTHER, "**shmhost %s %s" );
    }
    /* src/mpid/ch3/channels/shm/src/ch3_init.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**shmgetmem", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**shmgetmem" );
    /* src/mpid/ch3/channels/shm/src/ch3_finalize.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**finalize_progress_finalize", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**finalize_progress_finalize" );
    /* src/mpid/ch3/channels/shm/src/ch3_finalize.c */
    ...
    /* src/mpid/globus/mpig_recvq.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_vmpi|cancel_ras", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_vmpi|cancel_ras" );
    {
    /* src/mpid/globus/mpig_recvq.c */
    int i1 = MPI_REQUEST_NULL;
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_vmpi|cancel_ras", "**globus|cm_vmpi|cancel_ras %R", i1 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_vmpi|cancel_ras %R" );
    }
    /* src/mpid/globus/mpig_recvq.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_vmpi|reg_ras", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_vmpi|reg_ras" );
    /* src/mpid/globus/mpig_recvq.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_vmpi|unreg_ras", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_vmpi|unreg_ras" );
    /* src/mpid/globus/mpig_comm.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|pe_wait", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|pe_wait" );
    /* src/mpid/globus/mpig_comm.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|topology_comm_construct", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|topology_comm_construct" );
    {
    /* src/mpid/globus/mpig_comm.c */
    int i1 = MPI_COMM_WORLD;
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|topology_comm_construct", "*globus|topology_comm_construct %C", i1 );
    ChkMsg( err, MPI_ERR_OTHER, "*globus|topology_comm_construct %C" );
    }
    /* src/mpid/globus/mpig_comm.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|topology_comm_destruct", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|topology_comm_destruct" );
    {
    /* src/mpid/globus/mpig_comm.c */
    int i1 = MPI_COMM_WORLD;
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|topology_comm_destruct", "*globus|topology_comm_destruct %C", i1 );
    ChkMsg( err, MPI_ERR_OTHER, "*globus|topology_comm_destruct %C" );
    }
    /* src/mpid/globus/mpig_cm_other.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_other|recv_any_source", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_other|recv_any_source" );
    /* src/mpid/globus/mpig_cm_other.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_vmpi|iprobe_any_source", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_vmpi|iprobe_any_source" );
    /* src/mpid/globus/mpig_cm_other.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|recvq_fuaes", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|recvq_fuaes" );
    /* src/mpid/globus/mpig_cm_other.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|pe_poke", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|pe_poke" );
    /* src/mpid/globus/mpig_cm_other.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|recvq_deq_unexp_or_enq_posted", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|recvq_deq_unexp_or_enq_posted" );
    {
    /* src/mpid/globus/mpig_cm_other.c */
    int i1 = 1;
    int i2 = 2;
    int i3 = 3;
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|recvq_deq_unexp_or_enq_posted", "**globus|recvq_deq_unexp_or_enq_posted %d %d %d", i1, i2, i3 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|recvq_deq_unexp_or_enq_posted %d %d %d" );
    }
    /* src/mpid/globus/mpig_cm_other.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_other|vc_recv_any_source", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_other|vc_recv_any_source" );
    /* src/mpid/globus/mpig_bc.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**internrc", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**internrc" );
    {
    /* src/mpid/globus/mpig_bc.c */
    int i1 = 1;
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**internrc", "internrc %d", i1 );
    ChkMsg( err, MPI_ERR_OTHER, "internrc %d" );
    }
    /* src/mpid/globus/mpig_pm_gk.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|pm_finalized", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|pm_finalized" );
    /* src/mpid/globus/mpig_pm_gk.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|module_activate", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|module_activate" );
    {
    /* src/mpid/globus/mpig_pm_gk.c */
    char s1[] = "string1";
    char s2[] = "string2";
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|module_activate", "**globus|module_activate %s %s", s1, s2 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|module_activate %s %s" );
    }
    /* src/mpid/globus/mpig_pm_gk.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|pm_get_sjsize", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|pm_get_sjsize" );
    /* src/mpid/globus/mpig_pm_gk.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|pm_get_sjrank", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|pm_get_sjrank" );
    /* src/mpid/globus/mpig_pm_gk.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|pm_get_topology", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|pm_get_topology" );
    /* src/mpid/globus/mpig_pm_gk.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|pm_not_init", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|pm_not_init" );
    /* src/mpid/globus/mpig_pm_gk.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|module_deactivate", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|module_deactivate" );
    {
    /* src/mpid/globus/mpig_pm_gk.c */
    char s1[] = "string1";
    char s2[] = "string2";
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|module_deactivate", "**globus|module_deactivate %s %s", s1, s2 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|module_deactivate %s %s" );
    }
    /* src/mpid/globus/mpig_pm_gk.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|pm_pg_id_create", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|pm_pg_id_create" );
    /* src/mpid/globus/mpig_pm_gk.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|bc_add_contact", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|bc_add_contact" );
    {
    /* src/mpid/globus/mpig_pm_gk.c */
    char s1[] = "string1";
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|bc_add_contact", "**globus|bc_add_contact %s", s1 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|bc_add_contact %s" );
    }
    /* src/mpid/globus/mpig_pm_gk.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|pm_gk_sj_index_atoi", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|pm_gk_sj_index_atoi" );
    {
    /* src/mpid/globus/mpig_pm_gk.c */
    char s1[] = "string1";
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|pm_gk_sj_index_atoi", "**globus|pm_gk_sj_index_atoi %s", s1 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|pm_gk_sj_index_atoi %s" );
    }
    /* src/mpid/globus/mpig_pm_gk.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|bc_serialize", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|bc_serialize" );
    /* src/mpid/globus/mpig_pm_gk.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|pm_distribute_business_cards", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|pm_distribute_business_cards" );
    /* src/mpid/globus/mpig_pm_gk.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|bc_deserialize", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|bc_deserialize" );
    /* src/mpid/globus/mpig_pm_gk.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|bc_get_contact", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|bc_get_contact" );
    {
    /* src/mpid/globus/mpig_pm_gk.c */
    char s1[] = "string1";
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|bc_get_contact", "**globus|bc_get_contact %s", s1 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|bc_get_contact %s" );
    }
    /* src/mpid/globus/mpig_pm_gk.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|pm_gk_malformed_app_num", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|pm_gk_malformed_app_num" );
    {
    /* src/mpid/globus/mpig_pm_gk.c */
    char s1[] = "string1";
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|pm_gk_malformed_app_num", "**globus|pm_gk_malformed_app_num %s", s1 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|pm_gk_malformed_app_num %s" );
    }
    /* src/mpid/globus/mpig_pm_gk.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|pm_gk_insufficient_bc", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|pm_gk_insufficient_bc" );
    {
    /* src/mpid/globus/mpig_pm_gk.c */
    int i1 = 1;
    int i2 = 2;
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|pm_gk_insufficient_bc", "**globus|pm_gk_insufficient_bc %d %d", i1, i2 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|pm_gk_insufficient_bc %d %d" );
    }
    {
    /* src/mpid/globus/mpig_pm_gk.c */
    char s1[] = "string1";
    ...
    /* src/mpid/globus/mpig_pm_gk.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|bc_contact_not_found", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|bc_contact_not_found" );
    {
    /* src/mpid/globus/mpig_pm_gk.c */
    char s1[] = "string1";
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|bc_contact_not_found", "**globus|bc_contact_not_found %s", s1 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|bc_contact_not_found %s" );
    }
    /* src/mpid/globus/mpig_pm_gk.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|pm_no_exchange", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|pm_no_exchange" );
    /* src/mpid/globus/mpig_pm_gk.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|pm_gk_no_app_num", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|pm_gk_no_app_num" );
    /* src/mpid/globus/mpig_pm_gk.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|pm_gk_intra_subjob_receive", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|pm_gk_intra_subjob_receive" );
    {
    /* src/mpid/globus/mpig_pm_gk.c */
    char s1[] = "string1";
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|pm_gk_intra_subjob_receive", "**globus|pm_gk_intra_subjob_receive %s", s1 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|pm_gk_intra_subjob_receive %s" );
    }
    /* src/mpid/globus/mpig_pm_gk.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|pm_gk_intra_subjob_send", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|pm_gk_intra_subjob_send" );
    {
    /* src/mpid/globus/mpig_pm_gk.c */
    char s1[] = "string1";
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|pm_gk_intra_subjob_send", "**globus|pm_gk_intra_subjob_send %s", s1 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|pm_gk_intra_subjob_send %s" );
    }
    /* src/mpid/globus/mpig_pm_gk.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|pm_gk_intra_subjob_gather", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|pm_gk_intra_subjob_gather" );
    {
    /* src/mpid/globus/mpig_pm_gk.c */
    int i1 = 1;
    char s2[] = "string2";
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|pm_gk_intra_subjob_gather", "**globus|pm_gk_intra_subjob_gather %d %s", i1, s2 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|pm_gk_intra_subjob_gather %d %s" );
    }
    /* src/mpid/globus/mpig_pm_gk.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|pm_gk_intra_subjob_bcast", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|pm_gk_intra_subjob_bcast" );
    {
    /* src/mpid/globus/mpig_pm_gk.c */
    int i1 = 1;
    char s2[] = "string2";
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|pm_gk_intra_subjob_bcast", "**globus|pm_gk_intra_subjob_bcast %d %s", i1, s2 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|pm_gk_intra_subjob_bcast %d %s" );
    }
    /* src/mpid/globus/mpig_cm_xio_data.i */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|seg_pack_iov", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|seg_pack_iov" );
    /* src/mpid/globus/mpig_cm_xio_data.i */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|stream_trunc", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|stream_trunc" );
    /* src/mpid/globus/mpig_cm_xio_data.i */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|stream_rreq_unpack", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|stream_rreq_unpack" );
    /* src/mpid/globus/mpig_cm_self.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_self|hostname", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_self|hostname" );
    /* src/mpid/globus/mpig_cm_self.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_self|probedeadlock", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_self|probedeadlock" );
    /* src/mpid/globus/mpig_cm_self.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|recvq_deq_posted_or_enq_unexp", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|recvq_deq_posted_or_enq_unexp" );
    {
    /* src/mpid/globus/mpig_cm_self.c */
    int i1 = 1;
    int i2 = 2;
    int i3 = 3;
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|recvq_deq_posted_or_enq_unexp", "**globus|recvq_deq_posted_or_enq_unexp %d %d %d", i1, i2, i3 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|recvq_deq_posted_or_enq_unexp %d %d %d" );
    }
    /* src/mpid/globus/mpig_cm_xio_req.i */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|mutex_init", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|mutex_init" );
    /* src/mpid/globus/mpig_cm_xio_req.i */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cond_init", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cond_init" );
    /* src/mpid/globus/mpig_cm_xio_req.i */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|mutex_destroy", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|mutex_destroy" );
    /* src/mpid/globus/mpig_cm_xio_req.i */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cond_destroy", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cond_destroy" );
    /* src/mpid/globus/mpig_cm_vmpi.h */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|vmpi_fn_failed", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|vmpi_fn_failed" );
    {
    /* src/mpid/globus/mpig_cm_vmpi.h */
    char s1[] = "string1";
    char s2[] = "string2";
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|vmpi_fn_failed", "**globus|vmpi_fn_failed %s %s", s1, s2 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|vmpi_fn_failed %s %s" );
    }
    /* src/mpid/globus/mpig_topology.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|comm_create_key", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|comm_create_key" );
    {
    /* src/mpid/globus/mpig_topology.c */
    char s1[] = "string1";
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|comm_create_key", "**globus|comm_create_key %s", s1 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|comm_create_key %s" );
    }
    /* src/mpid/globus/mpig_topology.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|comm_destroy_key", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|comm_destroy_key" );
    {
    /* src/mpid/globus/mpig_topology.c */
    char s1[] = "string1";
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|comm_destroy_key", "**globus|comm_destroy_key %s", s1 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|comm_destroy_key %s" );
    }
    /* src/mpid/globus/mpig_topology.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|comm_set_attr", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|comm_set_attr" );
    {
    /* src/mpid/globus/mpig_topology.c */
    char s1[] = "string1";
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|comm_set_attr", "**globus|comm_set_attr %s", s1 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|comm_set_attr %s" );
    }
    /* src/mpid/globus/mpig_topology.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|get_vc_compatability", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|get_vc_compatability" );
    {
    /* src/mpid/globus/mpig_topology.c */
    char s1[] = "string1";
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|get_vc_compatability", "**globus|get_vc_compatability %s", s1 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|get_vc_compatability %s" );
    }
    /* src/mpid/globus/mpig_pm.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|pm_no_module", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|pm_no_module" );
    /* src/mpid/globus/mpig_cm_xio_conn.i */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|xio_server_reg_accept", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|xio_server_reg_accept" );
    {
    /* src/mpid/globus/mpig_cm_xio_conn.i */
    char s1[] = "string1";
    char s2[] = "string2";
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|xio_server_reg_accept", "**globus|cm_xio|xio_server_reg_accept %s %s", s1, s2 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|xio_server_reg_accept %s %s" );
    }
    /* src/mpid/globus/mpig_cm_xio_conn.i */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|server_handle_connection", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|server_handle_connection" );
    {
    /* src/mpid/globus/mpig_cm_xio_conn.i */
    char s1[] = "string1";
    char s2[] = "string2";
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|server_handle_connection", "**globus|cm_xio|server_handle_connection %s %s", s1, s2 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|server_handle_connection %s %s" );
    }
    {
    /* src/mpid/globus/mpig_cm_xio_conn.i */
    char s1[] = "string1";
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|server_handle_connection", "**globus|cm_xio|server_handle_connection %s", s1 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|server_handle_connection %s" );
    }
    /* src/mpid/globus/mpig_cm_xio_conn.i */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|server_listen", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|server_listen" );
    {
    /* src/mpid/globus/mpig_cm_xio_conn.i */
    char s1[] = "pointer1";
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|server_listen", "**globus|cm_xio|server_listen %p", s1 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|server_listen %p" );
    }
    /* src/mpid/globus/mpig_cm_xio_conn.i */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|disconnect_close_temp", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|disconnect_close_temp" );
    {
    /* src/mpid/globus/mpig_cm_xio_conn.i */
    char s1[] = "pointer1";
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|disconnect_close_temp", "**globus|cm_xio|disconnect_close_temp %p", s1 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|disconnect_close_temp %p" );
    }
    /* src/mpid/globus/mpig_cm_xio_conn.i */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|xio_reg_close", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|xio_reg_close" );
    {
    /* src/mpid/globus/mpig_cm_xio_conn.i */
    char s1[] = "pointer1";
    char s2[] = "string2";
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|xio_reg_close", "**globus|cm_xio|xio_reg_close %p %s", s1, s2 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|xio_reg_close %p %s" );
    }
    /* src/mpid/globus/mpig_cm_xio_conn.i */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|server_multiple_failures", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|server_multiple_failures" );
    /* src/mpid/globus/mpig_cm_xio_conn.i */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|server_reg_recv_magic", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|server_reg_recv_magic" );
    {
    /* src/mpid/globus/mpig_cm_xio_conn.i */
    char s1[] = "pointer1";
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|server_reg_recv_magic", "**globus|cm_xio|server_reg_recv_magic %p", s1 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|server_reg_recv_magic %p" );
    }
    /* src/mpid/globus/mpig_cm_xio_conn.i */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|server_reg_send_magic", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|server_reg_send_magic" );
    {
    /* src/mpid/globus/mpig_cm_xio_conn.i */
    char s1[] = "pointer1";
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|server_reg_send_magic", "**globus|cm_xio|server_reg_send_magic %p", s1 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|server_reg_send_magic %p" );
    }
    /* src/mpid/globus/mpig_cm_xio_conn.i */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|server_reg_recv_open_req", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|server_reg_recv_open_req" );
    {
    /* src/mpid/globus/mpig_cm_xio_conn.i */
    char s1[] = "pointer1";
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|server_reg_recv_open_req", "**globus|cm_xio|server_reg_recv_open_req %p", s1 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|server_reg_recv_open_req %p" );
    }
    /* src/mpid/globus/mpig_cm_xio_conn.i */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|server_handle_recv_open_proc_req", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|server_handle_recv_open_proc_req" );
    {
    /* src/mpid/globus/mpig_cm_xio_conn.i */
    char s1[] = "pointer1";
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|server_handle_recv_open_proc_req", "**globus|cm_xio|server_handle_recv_open_proc_req %p", s1 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|server_handle_recv_open_proc_req %p" );
    }
    /* src/mpid/globus/mpig_cm_xio_conn.i */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|server_handle_recv_open_port_req", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|server_handle_recv_open_port_req" );
    {
    /* src/mpid/globus/mpig_cm_xio_conn.i */
    char s1[] = "pointer1";
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|server_handle_recv_open_port_req", "**globus|cm_xio|server_handle_recv_open_port_req %p", s1 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|server_handle_recv_open_port_req %p" );
    }
    /* src/mpid/globus/mpig_cm_xio_conn.i */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|server_send_open_error_resp", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|server_send_open_error_resp" );
    {
    /* src/mpid/globus/mpig_cm_xio_conn.i */
    char s1[] = "pointer1";
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|server_send_open_error_resp", "**globus|cm_xio|server_send_open_error_resp %p", s1 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|server_send_open_error_resp %p" );
    }
    /* src/mpid/globus/mpig_cm_xio_conn.i */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|pg_acquire_ref", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|pg_acquire_ref" );
    {
    /* src/mpid/globus/mpig_cm_xio_conn.i */
    char s1[] = "string1";
    int i2 = 2;
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|pg_acquire_ref", "**globus|pg_acquire_ref %s %d", s1, i2 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|pg_acquire_ref %s %d" );
    }
    /* src/mpid/globus/mpig_cm_xio_conn.i */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|server_send_open_proc_resp_nak", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|server_send_open_proc_resp_nak" );
    {
    /* src/mpid/globus/mpig_cm_xio_conn.i */
    char s1[] = "pointer1";
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|server_send_open_proc_resp_nak", "**globus|cm_xio|server_send_open_proc_resp_nak %p", s1 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|server_send_open_proc_resp_nak %p" );
    }
    /* src/mpid/globus/mpig_cm_xio_conn.i */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|server_send_open_proc_resp_ack", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|server_send_open_proc_resp_ack" );
    {
    /* src/mpid/globus/mpig_cm_xio_conn.i */
    char s1[] = "pointer1";
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|server_send_open_proc_resp_ack", "**globus|cm_xio|server_send_open_proc_resp_ack %p", s1 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|server_send_open_proc_resp_ack %p" );
    }
    /* src/mpid/globus/mpig_cm_xio_conn.i */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|server_reg_send_open_proc_resp", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|server_reg_send_open_proc_resp" );
    {
    /* src/mpid/globus/mpig_cm_xio_conn.i */
    char s1[] = "pointer1";
    char s2[] = "string2";
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|server_reg_send_open_proc_resp", "**globus|cm_xio|server_reg_send_open_proc_resp %p %s", s1, s2 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|server_reg_send_open_proc_resp %p %s" );
    }
    /* src/mpid/globus/mpig_cm_xio_conn.i */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|server_handle_open_proc_resp_ack", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|server_handle_open_proc_resp_ack" );
    {
    /* src/mpid/globus/mpig_cm_xio_conn.i */
    char s1[] = "pointer1";
    char s2[] = "string2";
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|server_handle_open_proc_resp_ack", "**globus|server_handle_open_proc_resp_ack %p %s", s1, s2 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|server_handle_open_proc_resp_ack %p %s" );
    }
    /* src/mpid/globus/mpig_cm_xio_conn.i */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|recv_next_msg", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|recv_next_msg" );
    {
    /* src/mpid/globus/mpig_cm_xio_conn.i */
    char s1[] = "pointer1";
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|recv_next_msg", "**globus|cm_xio|recv_next_msg %p", s1 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|recv_next_msg %p" );
    }
    /* src/mpid/globus/mpig_cm_xio_conn.i */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|send_next_sreq", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|send_next_sreq" );
    {
    /* src/mpid/globus/mpig_cm_xio_conn.i */
    char s1[] = "pointer1";
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|send_next_sreq", "**globus|cm_xio|send_next_sreq %p", s1 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|send_next_sreq %p" );
    }
    /* src/mpid/globus/mpig_cm_xio_conn.i */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|client_reg_send_open_port_resp_ack", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|client_reg_send_open_port_resp_ack" );
    {
    /* src/mpid/globus/mpig_cm_xio_conn.i */
    char s1[] = "pointer1";
    char s2[] = "string2";
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|client_reg_send_open_port_resp_ack", "**globus|cm_xio|client_reg_send_open_port_resp_ack %p %s", s1, s2 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|client_reg_send_open_port_resp_ack %p %s" );
    }
    /* src/mpid/globus/mpig_cm_xio_conn.i */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|client_handle_send_open_port_resp_ack", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|client_handle_send_open_port_resp_ack" );
    {
    /* src/mpid/globus/mpig_cm_xio_conn.i */
    char s1[] = "pointer1";
    char s2[] = "string2";
    char s3[] = "string3";
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|client_handle_send_open_port_resp_ack", "**globus|cm_xio|client_handle_send_open_port_resp_ack %p %s %s", s1, s2, s3 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|client_handle_send_open_port_resp_ack %p %s %s" );
    }
    /* src/mpid/globus/mpig_cm_xio_conn.i */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|server_reg_send_open_resp", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|server_reg_send_open_resp" );
    {
    /* src/mpid/globus/mpig_cm_xio_conn.i */
    char s1[] = "pointer1";
    char s2[] = "string2";
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|server_reg_send_open_resp", "**globus|cm_xio|server_reg_send_open_resp %p %s", s1, s2 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|server_reg_send_open_resp %p %s" );
    }
    /* src/mpid/globus/mpig_cm_xio_conn.i */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|vc_ptr_bad", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|vc_ptr_bad" );
    {
    /* src/mpid/globus/mpig_cm_xio_conn.i */
    char s1[] = "pointer1";
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|vc_ptr_bad", "**globus|vc_ptr_bad %p", s1 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|vc_ptr_bad %p" );
    }
    /* src/mpid/globus/mpig_cm_xio_conn.i */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|client_handle_create", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|client_handle_create" );
    {
    /* src/mpid/globus/mpig_cm_xio_conn.i */
    char s1[] = "string1";
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|client_handle_create", "**globus|cm_xio|client_handle_create %s", s1 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|client_handle_create %s" );
    }
    /* src/mpid/globus/mpig_cm_xio_conn.i */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|xio_reg_open", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|xio_reg_open" );
    {
    /* src/mpid/globus/mpig_cm_xio_conn.i */
    char s1[] = "string1";
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|xio_reg_open", "**globus|cm_xio|xio_reg_open %s", s1 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|xio_reg_open %s" );
    }
    /* src/mpid/globus/mpig_cm_xio_conn.i */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|client_handle_open", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|client_handle_open" );
    {
    /* src/mpid/globus/mpig_cm_xio_conn.i */
    char s1[] = "pointer1";
    char s2[] = "string2";
    int i3 = 3;
    char s4[] = "string4";
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|client_handle_open", "**globus|cm_xio|client_handle_open %p %s %d %s", s1, s2, i3, s4 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|client_handle_open %p %s %d %s" );
    }
    /* src/mpid/globus/mpig_cm_xio_conn.i */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|client_reg_send_magic", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|client_reg_send_magic" );
    {
    /* src/mpid/globus/mpig_cm_xio_conn.i */
    char s1[] = "pointer1";
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|client_reg_send_magic", "**globus|cm_xio|client_reg_send_magic %p", s1 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|client_reg_send_magic %p" );
    }
    /* src/mpid/globus/mpig_cm_xio_conn.i */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|client_handle_send_magic", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|client_handle_send_magic" );
    {
    /* src/mpid/globus/mpig_cm_xio_conn.i */
    char s1[] = "pointer1";
    char s2[] = "string2";
    int i3 = 3;
    char s4[] = "string4";
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|client_handle_send_magic", "**globus|cm_xio|client_handle_send_magic %p %s %d %s", s1, s2, i3, s4 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|client_handle_send_magic %p %s %d %s" );
    }
    /* src/mpid/globus/mpig_cm_xio_conn.i */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|client_reg_recv_magic", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|client_reg_recv_magic" );
    {
    /* src/mpid/globus/mpig_cm_xio_conn.i */
    char s1[] = "pointer1";
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|client_reg_recv_magic", "**globus|cm_xio|client_reg_recv_magic %p", s1 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|client_reg_recv_magic %p" );
    }
    /* src/mpid/globus/mpig_cm_xio_conn.i */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|client_handle_recv_magic", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|client_handle_recv_magic" );
    {
    /* src/mpid/globus/mpig_cm_xio_conn.i */
    char s1[] = "pointer1";
    char s2[] = "string2";
    int i3 = 3;
    char s4[] = "string4";
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|client_handle_recv_magic", "**globus|cm_xio|client_handle_recv_magic %p %s %d %s", s1, s2, i3, s4 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|client_handle_recv_magic %p %s %d %s" );
    }
    /* src/mpid/globus/mpig_cm_xio_conn.i */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|client_magic_mismatch", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|client_magic_mismatch" );
    {
    /* src/mpid/globus/mpig_cm_xio_conn.i */
    char s1[] = "pointer1";
    char s2[] = "string2";
    int i3 = 3;
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|client_magic_mismatch", "**globus|cm_xio|client_magic_mismatch %p %s %d", s1, s2, i3 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|client_magic_mismatch %p %s %d" );
    }
    /* src/mpid/globus/mpig_cm_xio_conn.i */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|send_open_proc_req", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|send_open_proc_req" );
    {
    /* src/mpid/globus/mpig_cm_xio_conn.i */
    char s1[] = "pointer1";
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|send_open_proc_req", "**globus|cm_xio|send_open_proc_req %p", s1 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|send_open_proc_req %p" );
    }
    /* src/mpid/globus/mpig_cm_xio_conn.i */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|send_open_port_req", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|send_open_port_req" );
    {
    /* src/mpid/globus/mpig_cm_xio_conn.i */
    char s1[] = "pointer1";
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|send_open_port_req", "**globus|cm_xio|send_open_port_req %p", s1 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|send_open_port_req %p" );
    }
    /* src/mpid/globus/mpig_cm_xio_conn.i */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|client_reg_send_open_proc_req", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|client_reg_send_open_proc_req" );
    {
    /* src/mpid/globus/mpig_cm_xio_conn.i */
    char s1[] = "pointer1";
    char s2[] = "string2";
    int i3 = 3;
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|client_reg_send_open_proc_req", "**globus|cm_xio|client_reg_send_open_proc_req %p %s %d", s1, s2, i3 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|client_reg_send_open_proc_req %p %s %d" );
    }
    /* src/mpid/globus/mpig_cm_xio_conn.i */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|client_handle_send_open_proc_req", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|client_handle_send_open_proc_req" );
    {
    /* src/mpid/globus/mpig_cm_xio_conn.i */
    char s1[] = "pointer1";
    char s2[] = "string2";
    int i3 = 3;
    char s4[] = "string4";
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|client_handle_send_open_proc_req", "**globus|cm_xio|client_handle_send_open_proc_req %p %s %d %s", s1, s2, i3, s4 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|client_handle_send_open_proc_req %p %s %d %s" );
    }
    /* src/mpid/globus/mpig_cm_xio_conn.i */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|client_reg_recv_open_proc_resp", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|client_reg_recv_open_proc_resp" );
    {
    /* src/mpid/globus/mpig_cm_xio_conn.i */
    char s1[] = "pointer1";
    char s2[] = "string2";
    int i3 = 3;
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|client_reg_recv_open_proc_resp", "**globus|cm_xio|client_reg_recv_open_proc_resp %p %s %d", s1, s2, i3 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|client_reg_recv_open_proc_resp %p %s %d" );
    }
    /* src/mpid/globus/mpig_cm_xio_conn.i */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|client_handle_recv_open_proc_resp", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|client_handle_recv_open_proc_resp" );
    {
    /* src/mpid/globus/mpig_cm_xio_conn.i */
    char s1[] = "pointer1";
    char s2[] = "string2";
    int i3 = 3;
    char s4[] = "string4";
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|client_handle_recv_open_proc_resp", "**globus|cm_xio|client_handle_recv_open_proc_resp %p %s %d %s", s1, s2, i3, s4 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|client_handle_recv_open_proc_resp %p %s %d %s" );
    }
    /* src/mpid/globus/mpig_cm_xio_conn.i */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|client_reg_recv_open_resp", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|client_reg_recv_open_resp" );
    {
    /* src/mpid/globus/mpig_cm_xio_conn.i */
    char s1[] = "pointer1";
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|client_reg_recv_open_resp", "**globus|cm_xio|client_reg_recv_open_resp %p", s1 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|client_reg_recv_open_resp %p" );
    }
    {
    /* src/mpid/globus/mpig_cm_xio_conn.i */
    char s1[] = "pointer1";
    char s2[] = "string2";
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|client_handle_create", "**globus|cm_xio|client_handle_create %p %s", s1, s2 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|client_handle_create %p %s" );
    }
    {
    /* src/mpid/globus/mpig_cm_xio_conn.i */
    char s1[] = "pointer1";
    char s2[] = "string2";
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|xio_reg_open", "**globus|cm_xio|xio_reg_open %p %s", s1, s2 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|xio_reg_open %p %s" );
    }
    /* src/mpid/globus/mpig_cm_xio_conn.i */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|client_reg_send_open_port_req", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|client_reg_send_open_port_req" );
    {
    /* src/mpid/globus/mpig_cm_xio_conn.i */
    char s1[] = "pointer1";
    char s2[] = "string2";
    char s3[] = "string3";
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|client_reg_send_open_port_req", "**globus|cm_xio|client_reg_send_open_port_req %p %s %s", s1, s2, s3 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|client_reg_send_open_port_req %p %s %s" );
    }
    /* src/mpid/globus/mpig_cm_xio_conn.i */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|client_handle_send_open_port_req", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|client_handle_send_open_port_req" );
    {
    /* src/mpid/globus/mpig_cm_xio_conn.i */
    char s1[] = "pointer1";
    char s2[] = "string2";
    char s3[] = "string3";
    char s4[] = "string4";
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|client_handle_send_open_port_req", "**globus|cm_xio|client_handle_send_open_port_req %p %s %s %s", s1, s2, s3, s4 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|client_handle_send_open_port_req %p %s %s %s" );
    }
    /* src/mpid/globus/mpig_cm_xio_conn.i */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|client_reg_recv_open_port_resp", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|client_reg_recv_open_port_resp" );
    {
    /* src/mpid/globus/mpig_cm_xio_conn.i */
    char s1[] = "pointer1";
    char s2[] = "string2";
    char s3[] = "string3";
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|client_reg_recv_open_port_resp", "**globus|cm_xio|client_reg_recv_open_port_resp %p %s %s", s1, s2, s3 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|client_reg_recv_open_port_resp %p %s %s" );
    }
    /* src/mpid/globus/mpig_cm_xio_conn.i */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|client_handle_recv_open_port_resp", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|client_handle_recv_open_port_resp" );
    {
    /* src/mpid/globus/mpig_cm_xio_conn.i */
    char s1[] = "pointer1";
    char s2[] = "string2";
    char s3[] = "string3";
    char s4[] = "string4";
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|client_handle_recv_open_port_resp", "**globus|cm_xio|client_handle_recv_open_port_resp %p %s %s %s", s1, s2, s3, s4 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|client_handle_recv_open_port_resp %p %s %s %s" );
    }
    /* src/mpid/globus/mpig_cm_xio_conn.i */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|client_handle_port_not_found", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|client_handle_port_not_found" );
    {
    /* src/mpid/globus/mpig_cm_xio_conn.i */
    char s1[] = "pointer1";
    char s2[] = "string2";
    char s3[] = "string3";
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|client_handle_port_not_found", "**globus|cm_xio|client_handle_port_not_found %p %s %s", s1, s2, s3 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|client_handle_port_not_found %p %s %s" );
    }
    /* src/mpid/globus/mpig_cm_xio_conn.i */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|client_handle_port_enq_failed", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|client_handle_port_enq_failed" );
    {
    /* src/mpid/globus/mpig_cm_xio_conn.i */
    char s1[] = "pointer1";
    char s2[] = "string2";
    char s3[] = "string3";
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|client_handle_port_enq_failed", "**globus|cm_xio|client_handle_port_enq_failed %p %s %s", s1, s2, s3 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|client_handle_port_enq_failed %p %s %s" );
    }
    /* src/mpid/globus/mpig_cm_xio_conn.i */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|client_handle_port_closing", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|client_handle_port_closing" );
    {
    /* src/mpid/globus/mpig_cm_xio_conn.i */
    char s1[] = "pointer1";
    char s2[] = "string2";
    char s3[] = "string3";
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|client_handle_port_closing", "**globus|cm_xio|client_handle_port_closing %p %s %s", s1, s2, s3 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|client_handle_port_closing %p %s %s" );
    }
    /* src/mpid/globus/mpig_cm_xio_conn.i */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|client_handle_port_unexp_resp", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|client_handle_port_unexp_resp" );
    {
    /* src/mpid/globus/mpig_cm_xio_conn.i */
    char s1[] = "pointer1";
    char s2[] = "string2";
    ...
    int i4 = 4;
    char s5[] = "string5";
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|client_handle_port_unexp_resp", "**globus|cm_xio|client_handle_port_unexp_resp %p %s %s %d %s", s1, s2, s3, i4, s5 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|client_handle_port_unexp_resp %p %s %s %d %s" );
    }
    /* src/mpid/globus/mpig_cm_xio_conn.i */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|disconnect_send_enq_close_msg", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|disconnect_send_enq_close_msg" );
    {
    /* src/mpid/globus/mpig_cm_xio_conn.i */
    char s1[] = "pointer1";
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|disconnect_send_enq_close_msg", "**globus|cm_xio|disconnect_send_enq_close_msg %p", s1 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|disconnect_send_enq_close_msg %p" );
    }
    /* src/mpid/globus/mpig_cm_xio_conn.i */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|send_enq_sreq", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|send_enq_sreq" );
    {
    /* src/mpid/globus/mpig_cm_xio_conn.i */
    char s1[] = "pointer1";
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|send_enq_sreq", "**globus|cm_xio|send_enq_sreq %p", s1 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|send_enq_sreq %p" );
    }
    /* src/mpid/globus/mpig_cm_xio_conn.i */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|disconnect_handle_send_close_msg", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|disconnect_handle_send_close_msg" );
    {
    /* src/mpid/globus/mpig_cm_xio_conn.i */
    char s1[] = "pointer1";
    char s2[] = "string2";
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|disconnect_handle_send_close_msg", "**globus|cm_xio|disconnect_handle_send_close_msg %p %s", s1, s2 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|disconnect_handle_send_close_msg %p %s" );
    }
    /* src/mpid/globus/mpig_cm_xio_conn.i */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|disconnnect_handle_close_proc", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|disconnnect_handle_close_proc" );
    {
    /* src/mpid/globus/mpig_cm_xio_conn.i */
    char s1[] = "pointer1";
    char s2[] = "string2";
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|disconnnect_handle_close_proc", "**globus|cm_xio|disconnnect_handle_close_proc %p %s", s1, s2 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|disconnnect_handle_close_proc %p %s" );
    }
    /* src/mpid/globus/mpig_cm_xio_conn.i */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|client_connect_proc", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|client_connect_proc" );
    {
    /* src/mpid/globus/mpig_cm_xio_conn.i */
    char s1[] = "pointer1";
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|client_connect_proc", "**globus|cm_xio|client_connect_proc %p", s1 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|client_connect_proc %p" );
    }
    /* src/mpid/globus/mpig_cm_xio_conn.i */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|port_name_too_long", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|port_name_too_long" );
    {
    /* src/mpid/globus/mpig_cm_xio_conn.i */
    int i1 = 1;
    int i2 = 2;
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|port_name_too_long", "**globus|cm_xio|port_name_too_long %d %d", i1, i2 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|port_name_too_long %d %d" );
    }
    /* src/mpid/globus/mpig_cm_xio_conn.i */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|port_list_insert", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|port_list_insert" );
    /* src/mpid/globus/mpig_cm_xio_conn.i */
    ...
    /* src/mpid/globus/mpig_cm_xio_conn.i */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio_port_find_and_lock", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio_port_find_and_lock" );
    {
    /* src/mpid/globus/mpig_cm_xio_conn.i */
    char s1[] = "string1";
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio_port_find_and_lock", "**globus|cm_xio_port_find_and_lock %s", s1 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio_port_find_and_lock %s" );
    }
    /* src/mpid/globus/mpig_cm_xio_conn.i */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|port_dequeue_vc", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|port_dequeue_vc" );
    {
    /* src/mpid/globus/mpig_cm_xio_conn.i */
    char s1[] = "string1";
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|port_dequeue_vc", "**globus|cm_xio|port_dequeue_vc %s", s1 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|port_dequeue_vc %s" );
    }
    /* src/mpid/globus/mpig_cm_xio_conn.i */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|server_send_open_port_resp", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|server_send_open_port_resp" );
    {
    /* src/mpid/globus/mpig_cm_xio_conn.i */
    char s1[] = "string1";
    char s2[] = "pointer2";
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|server_send_open_port_resp", "**globus|cm_xio|server_send_open_port_resp %s %p", s1, s2 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|server_send_open_port_resp %s %p" );
    }
    /* src/mpid/globus/mpig_cm_xio_conn.i */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|server_port_vc_failed", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|server_port_vc_failed" );
    {
    /* src/mpid/globus/mpig_cm_xio_conn.i */
    char s1[] = "string1";
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|server_port_vc_failed", "**globus|cm_xio|server_port_vc_failed %s", s1 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|server_port_vc_failed %s" );
    }
    /* src/mpid/globus/mpig_cm_xio_conn.i */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|client_connect_port", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|client_connect_port" );
    {
    /* src/mpid/globus/mpig_cm_xio_conn.i */
    char s1[] = "string1";
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|client_connect_port", "**globus|cm_xio|client_connect_port %s", s1 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|client_connect_port %s" );
    }
    /* src/mpid/globus/mpig_cm_xio_conn.i */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|client_port_vc_failed", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|client_port_vc_failed" );
    {
    /* src/mpid/globus/mpig_cm_xio_conn.i */
    char s1[] = "string1";
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|client_port_vc_failed", "**globus|cm_xio|client_port_vc_failed %s", s1 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|client_port_vc_failed %s" );
    }
    {
    /* src/mpid/globus/mpig_cm_xio_conn.i */
    char s1[] = "pointer1";
    char s2[] = "string2";
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|xio_reg_close", "**globus|cm_xio|xio_write %p %s", s1, s2 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|xio_write %p %s" );
    }
    {
    /* src/mpid/globus/mpig_cm_xio_conn.i */
    char s1[] = "pointer1";
    char s2[] = "string2";
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|xio_reg_close", "**globus|cm_xio|xio_read %p %s", s1, s2 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|xio_read %p %s" );
    }
    /* src/mpid/globus/mpig_cm_xio_conn.i */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|fifo_enq", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|fifo_enq" );
    /* src/mpid/globus/mpid_progress.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_pe_wait", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_pe_wait" );
    {
    /* src/mpid/globus/mpid_progress.c */
    char s1[] = "string1";
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_pe_wait", "**globus|cm_pe_wait %s", s1 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_pe_wait %s" );
    }
    /* src/mpid/globus/mpid_progress.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_pe_test", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_pe_test" );
    {
    /* src/mpid/globus/mpid_progress.c */
    char s1[] = "string1";
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_pe_test", "**globus|cm_pe_test %s", s1 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_pe_test %s" );
    }
    /* src/mpid/globus/mpig_cm_xio_comm.i */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|xio_reg_write", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|xio_reg_write" );
    {
    /* src/mpid/globus/mpig_cm_xio_comm.i */
    char s1[] = "string1";
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|xio_reg_write", "**globus|cm_xio|xio_reg_write %s", s1 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|xio_reg_write %s" );
    }
    /* src/mpid/globus/mpig_cm_xio_comm.i */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|xio_reg_writev", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|xio_reg_writev" );
    {
    /* src/mpid/globus/mpig_cm_xio_comm.i */
    char s1[] = "string1";
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|xio_reg_writev", "**globus|cm_xio|xio_reg_writev %s", s1 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|xio_reg_writev %s" );
    }
    /* src/mpid/globus/mpig_cm_xio_comm.i */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|xio_reg_read", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|xio_reg_read" );
    {
    /* src/mpid/globus/mpig_cm_xio_comm.i */
    char s1[] = "string1";
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|xio_reg_read", "**globus|cm_xio|xio_reg_read %s", s1 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|xio_reg_read %s" );
    }
    /* src/mpid/globus/mpig_cm_xio_comm.i */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|xio_reg_readv", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|xio_reg_readv" );
    {
    /* src/mpid/globus/mpig_cm_xio_comm.i */
    char s1[] = "string1";
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|xio_reg_readv", "**globus|cm_xio|xio_reg_readv %s", s1 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|xio_reg_readv %s" );
    }
    /* src/mpid/globus/mpig_cm_xio_comm.i */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|vc_connection", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|vc_connection" );
    {
    /* src/mpid/globus/mpig_cm_xio_comm.i */
    char s1[] = "string1";
    int i2 = 2;
    char s3[] = "string3";
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|vc_connection", "**globus|cm_xio|vc_connection %s %d %s", s1, i2, s3 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|vc_connection %s %d %s" );
    }
    /* src/mpid/globus/mpig_cm_xio_comm.i */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|vc_uninit", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|vc_uninit" );
    {
    /* src/mpid/globus/mpig_cm_xio_comm.i */
    char s1[] = "pointer1";
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|vc_uninit", "**globus|cm_xio|vc_uninit %p", s1 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|vc_uninit %p" );
    }
    /* src/mpid/globus/mpig_cm_xio_comm.i */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|vc_corrupt", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|vc_corrupt" );
    {
    /* src/mpid/globus/mpig_cm_xio_comm.i */
    char s1[] = "pointer1";
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|vc_corrupt", "**globus|cm_xio|vc_corrupt %p", s1 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|vc_corrupt %p" );
    }
    /* src/mpid/globus/mpig_cm_xio_comm.i */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|reg_write_sreq", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|reg_write_sreq" );
    /* src/mpid/globus/mpig_cm_xio_comm.i */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|stream_sreq_init", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|stream_sreq_init" );
    /* src/mpid/globus/mpig_cm_xio_comm.i */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|stream_sreq_pack", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|stream_sreq_pack" );
    /* src/mpid/globus/mpig_cm_xio_comm.i */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|send_handle_msg_data", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|send_handle_msg_data" );
    {
    /* src/mpid/globus/mpig_cm_xio_comm.i */
    char s1[] = "string1";
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|send_handle_msg_data", "**globus|cm_xio|send_handle_write_msg_data %s", s1 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|send_handle_write_msg_data %s" );
    }
    /* src/mpid/globus/mpig_cm_xio_comm.i */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|send_enq_rndv_data_msg", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|send_enq_rndv_data_msg" );
    /* src/mpid/globus/mpig_cm_xio_comm.i */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|send_handle_write_control_msg", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|send_handle_write_control_msg" );
    {
    /* src/mpid/globus/mpig_cm_xio_comm.i */
    char s1[] = "string1";
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|send_handle_write_control_msg", "**globus|cm_xio|send_handle_write_contro_msg %s", s1 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|send_handle_write_contro_msg %s" );
    }
    /* src/mpid/globus/mpig_cm_xio_comm.i */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|reg_read_vc_msgbuf", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|reg_read_vc_msgbuf" );
    /* src/mpid/globus/mpig_cm_xio_comm.i */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|recv_handle_incoming_msg", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|recv_handle_incoming_msg" );
    {
    /* src/mpid/globus/mpig_cm_xio_comm.i */
    char s1[] = "string1";
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|recv_handle_incoming_msg", "**globus|cm_xio|recv_handle_incoming_msg %s", s1 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|recv_handle_incoming_msg %s" );
    }
    /* src/mpid/globus/mpig_cm_xio_comm.i */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|msg_handler", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|msg_handler" );
    /* src/mpid/globus/mpig_cm_xio_comm.i */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|send_enq_ssend_ack_msg", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|send_enq_ssend_ack_msg" );
    /* src/mpid/globus/mpig_cm_xio_comm.i */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|stream_rreq_init", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|stream_rreq_init" );
    /* src/mpid/globus/mpig_cm_xio_comm.i */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|stream_rreq_unpack_vc_msgbuf", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|stream_rreq_unpack_vc_msgbuf" );
    /* src/mpid/globus/mpig_cm_xio_comm.i */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|reg_read_rreq", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|reg_read_rreq" );
    /* src/mpid/globus/mpig_cm_xio_comm.i */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|send_enq_rndv_cts_msg", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|send_enq_rndv_cts_msg" );
    /* src/mpid/globus/mpig_cm_xio_comm.i */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|request_get_ptr", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|request_get_ptr" );
    {
    /* src/mpid/globus/mpig_cm_xio_comm.i */
    int i1 = MPI_REQUEST_NULL;
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|request_get_ptr", "**globus|request_get_ptr %R", i1 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|request_get_ptr %R" );
    }
    /* src/mpid/globus/mpig_cm_xio_comm.i */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|send_enq_cancel_send_resp_msg", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|send_enq_cancel_send_resp_msg" );
    /* src/mpid/globus/mpig_cm_xio_comm.i */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|req_recv_state", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|req_recv_state" );
    {
    /* src/mpid/globus/mpig_cm_xio_comm.i */
    char s1[] = "string1";
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|req_recv_state", "**globus|cm_xio|req_recv_state %s", s1 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|req_recv_state %s" );
    }
    /* src/mpid/globus/mpig_cm_xio_comm.i */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|recv_handle_xio_read_msg_data", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|recv_handle_xio_read_msg_data" );
    {
    /* src/mpid/globus/mpig_cm_xio_comm.i */
    char s1[] = "string1";
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|recv_handle_xio_read_msg_data", "**globus|cm_xio|recv_handle_read_msg_data %s", s1 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|recv_handle_read_msg_data %s" );
    }
    /* src/mpid/globus/mpig_cm_xio_comm.i */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|stream_req_init", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|stream_req_init" );
    /* src/mpid/globus/mpig_cm_xio_comm.i */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|disconnect_close_proc", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|disconnect_close_proc" );
    /* src/mpid/globus/mpid_env.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|recvq_init", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|recvq_init" );
    /* src/mpid/globus/mpid_env.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|pm_init", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|pm_init" );
    /* src/mpid/globus/mpid_env.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm|init", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm|init" );
    {
    /* src/mpid/globus/mpid_env.c */
    char s1[] = "string1";
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm|init", "**globus|cm|init %s", s1 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm|init %s" );
    }
    /* src/mpid/globus/mpid_env.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm|add_contact_info", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm|add_contact_info" );
    {
    /* src/mpid/globus/mpid_env.c */
    char s1[] = "string1";
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm|add_contact_info", "**globus|cm|add_contact_info %s", s1 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm|add_contact_info %s" );
    }
    /* src/mpid/globus/mpid_env.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|pm_xchg", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|pm_xchg" );
    /* src/mpid/globus/mpid_env.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|bc_copy", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|bc_copy" );
    /* src/mpid/globus/mpid_env.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|vc_construct_contact_info", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|vc_construct_contact_info" );
    {
    /* src/mpid/globus/mpid_env.c */
    char s1[] = "string1";
    int i2 = 2;
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|vc_construct_contact_info", "**globus|vc_construct_contact_info %s %d", s1, i2 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|vc_construct_contact_info %s %d" );
    }
    /* src/mpid/globus/mpid_env.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|vc_select_comm_method", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|vc_select_comm_method" );
    {
    /* src/mpid/globus/mpid_env.c */
    char s1[] = "string1";
    int i2 = 2;
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|vc_select_comm_method", "**globus|vc_select_comm_method %s %d", s1, i2 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|vc_select_comm_method %s %d" );
    }
    /* src/mpid/globus/mpid_env.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|topology_init", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|topology_init" );
    /* src/mpid/globus/mpid_env.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|comm_init", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|comm_init" );
    {
    /* src/mpid/globus/mpid_env.c */
    char s1[] = "string1";
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**dev|vcrt_get_ptr", "**dev|vcrt_get_ptr %s", s1 );
    ...
    /* src/mpid/globus/mpid_env.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|comm_finalize", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|comm_finalize" );
    /* src/mpid/globus/mpid_env.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|topology_finalize", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|topology_finalize" );
    /* src/mpid/globus/mpid_env.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm|finalize", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm|finalize" );
    {
    /* src/mpid/globus/mpid_env.c */
    char s1[] = "string1";
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm|finalize", "**globus|cm|finalize %s", s1 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm|finalize %s" );
    }
    /* src/mpid/globus/mpid_env.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**dev|pg_finalize", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**dev|pg_finalize" );
    /* src/mpid/globus/mpid_env.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|pm_finalize", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|pm_finalize" );
    /* src/mpid/globus/mpid_env.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|recvq_finalize", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|recvq_finalize" );
    {
    /* src/mpid/globus/mpid_env.c */
    char s1[] = "string1";
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|module_deactivate", "**globus|module_deactivate %s", s1 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|module_deactivate %s" );
    }
    /* src/mpid/globus/mpig_cm_xio_nets.i */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|module_init", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|module_init" );
    /* src/mpid/globus/mpig_cm_xio_nets.i */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|xio_stack_init", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|xio_stack_init" );
    {
    /* src/mpid/globus/mpig_cm_xio_nets.i */
    char s1[] = "string1";
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|xio_stack_init", "**globus|cm_xio|xio_stack_init %s", s1 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|xio_stack_init %s" );
    }
    /* src/mpid/globus/mpig_cm_xio_nets.i */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|xio_driver_load_transport", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|xio_driver_load_transport" );
    {
    /* src/mpid/globus/mpig_cm_xio_nets.i */
    char s1[] = "string1";
    char s2[] = "string2";
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|xio_driver_load_transport", "**globus|cm_xio|xio_driver_load_transport %s %s", s1, s2 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|xio_driver_load_transport %s %s" );
    }
    /* src/mpid/globus/mpig_cm_xio_nets.i */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|xio_stack_push_driver", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|xio_stack_push_driver" );
    {
    /* src/mpid/globus/mpig_cm_xio_nets.i */
    char s1[] = "string1";
    char s2[] = "string2";
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|xio_stack_push_driver", "**globus|cm_xio|xio_stack_push_driver %s %s", s1, s2 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|xio_stack_push_driver %s %s" );
    }
    /* src/mpid/globus/mpig_cm_xio_nets.i */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|xio_driver_load_transform", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|xio_driver_load_transform" );
    {
    /* src/mpid/globus/mpig_cm_xio_nets.i */
    char s1[] = "string1";
    char s2[] = "string2";
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|xio_driver_load_transform", "**globus|cm_xio|xio_driver_load_transform %s %s", s1, s2 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|xio_driver_load_transform %s %s" );
    }
    /* src/mpid/globus/mpig_cm_xio_nets.i */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|xio_attr_init", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|xio_attr_init" );
    {
    /* src/mpid/globus/mpig_cm_xio_nets.i */
    char s1[] = "string1";
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|xio_attr_init", "**globus|cm_xio|xio_attr_init %s", s1 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|xio_attr_init %s" );
    }
    /* src/mpid/globus/mpig_cm_xio_nets.i */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|xio_attr_cntl", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|xio_attr_cntl" );
    {
    /* src/mpid/globus/mpig_cm_xio_nets.i */
    char s1[] = "string1";
    char s2[] = "string2";
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|xio_attr_cntl", "**globus|cm_xio|xio_attr_cntl %s %s", s1, s2 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|xio_attr_cntl %s %s" );
    }
    /* src/mpid/globus/mpig_cm_xio_nets.i */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|server_create", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|server_create" );
    {
    /* src/mpid/globus/mpig_cm_xio_nets.i */
    char s1[] = "string1";
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|server_create", "**globus|cm_xio|server_create %s", s1 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|server_create %s" );
    }
    /* src/mpid/globus/mpig_cm_xio_nets.i */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|server_get_cs", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|server_get_cs" );
    {
    /* src/mpid/globus/mpig_cm_xio_nets.i */
    char s1[] = "string1";
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|server_get_cs", "**globus|cm_xio|server_get_cs %s", s1 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|server_get_cs %s" );
    }
    {
    /* src/mpid/globus/mpig_cm_xio_nets.i */
    char s1[] = "string1";
    char s2[] = "pointer2";
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|server_listen", "**globus|cm_xio|server_listen %s %p", s1, s2 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|server_listen %s %p" );
    }
    /* src/mpid/globus/mpig_cm_xio_nets.i */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|nets_init", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|nets_init" );
    {
    /* src/mpid/globus/mpig_cm_xio_nets.i */
    char s1[] = "pointer1";
    char s2[] = "string2";
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|nets_init", "**globus|cm_xio|nets_init %p %s", s1, s2 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|nets_init %p %s" );
    }
    /* src/mpid/globus/mpig_cm_xio_nets.i */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|xio_close_server", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|xio_close_server" );
    {
    /* src/mpid/globus/mpig_cm_xio_nets.i */
    char s1[] = "string1";
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|xio_close_server", "**globus|cm_xio|xio_close_server %s", s1 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|xio_close_server %s" );
    }
    /* src/mpid/globus/mpig_cm_xio_nets.i */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|xio_stack_destroy", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|xio_stack_destroy" );
    {
    /* src/mpid/globus/mpig_cm_xio_nets.i */
    char s1[] = "string1";
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|xio_stack_destroy", "**globus|cm_xio|xio_stack_destroy %s", s1 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|xio_stack_destroy %s" );
    }
    /* src/mpid/globus/mpig_cm_xio_nets.i */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|xio_driver_unload_transport", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|xio_driver_unload_transport" );
    {
    /* src/mpid/globus/mpig_cm_xio_nets.i */
    char s1[] = "string1";
    char s2[] = "string2";
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|xio_driver_unload_transport", "**globus|cm_xio|xio_driver_destroy_unload_transport %s %s", s1, s2 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|xio_driver_destroy_unload_transport %s %s" );
    }
    /* src/mpid/globus/mpig_cm_xio_nets.i */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|xio_attr_destroy", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|xio_attr_destroy" );
    {
    /* src/mpid/globus/mpig_cm_xio_nets.i */
    char s1[] = "string1";
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|xio_attr_destroy", "**globus|cm_xio|xio_attr_destroy %s", s1 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|xio_attr_destroy %s" );
    }
    /* src/mpid/globus/mpid_services.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|connacc|open_port", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|connacc|open_port" );
    {
    /* src/mpid/globus/mpid_services.c */
    char s1[] = "pointer1";
    char s2[] = "pointer2";
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|connacc|open_port", "**globus|connacc|open_port %p %p", s1, s2 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|connacc|open_port %p %p" );
    }
    /* src/mpid/globus/mpid_services.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|connacc|close_port", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|connacc|close_port" );
    {
    /* src/mpid/globus/mpid_services.c */
    char s1[] = "string1";
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|connacc|close_port", "**globus|connacc|close_port %s", s1 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|connacc|close_port %s" );
    }
    /* src/mpid/globus/mpid_services.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|connacc|vcrt_serialize", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|connacc|vcrt_serialize" );
    {
    /* src/mpid/globus/mpid_services.c */
    char s1[] = "string1";
    int i2 = MPI_COMM_WORLD;
    char s3[] = "pointer3";
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|connacc|vcrt_serialize", "**globus|connacc|vcrt_serialize %s %C %p", s1, i2, s3 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|connacc|vcrt_serialize %s %C %p" );
    }
    /* src/mpid/globus/mpid_services.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|connacc|port_accept", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|connacc|port_accept" );
    {
    /* src/mpid/globus/mpid_services.c */
    char s1[] = "string1";
    int i2 = 2;
    int i3 = MPI_COMM_WORLD;
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|connacc|port_accept", "**globus|connacc|port_accept %s %i %C", s1, i2, i3 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|connacc|port_accept %s %i %C" );
    }
    /* src/mpid/globus/mpid_services.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|connacc|port_vc_send", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|connacc|port_vc_send" );
    {
    /* src/mpid/globus/mpid_services.c */
    char s1[] = "pointer1";
    char s2[] = "pointer2";
    char s3[] = "string3";
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|connacc|port_vc_send", "**globus|connacc|port_vc_send %p %p %s", s1, s2, s3 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|connacc|port_vc_send %p %p %s" );
    }
    /* src/mpid/globus/mpid_services.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|connacc|port_vc_recv", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|connacc|port_vc_recv" );
    {
    /* src/mpid/globus/mpid_services.c */
    char s1[] = "pointer1";
    char s2[] = "pointer2";
    char s3[] = "string3";
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|connacc|port_vc_recv", "**globus|connacc|port_vc_recv %p %p %s", s1, s2, s3 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|connacc|port_vc_recv %p %p %s" );
    }
    {
    /* src/mpid/globus/mpid_services.c */
    char s1[] = "pointer1";
    char s2[] = "pointer2";
    int i3 = 3;
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|connacc|port_vc_send", "**globus|connacc|port_vc_send %p %p %d", s1, s2, i3 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|connacc|port_vc_send %p %p %d" );
    }
    {
    /* src/mpid/globus/mpid_services.c */
    char s1[] = "pointer1";
    char s2[] = "pointer2";
    int i3 = 3;
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|connacc|port_vc_recv", "**globus|connacc|port_vc_recv %p %p %d", s1, s2, i3 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|connacc|port_vc_recv %p %p %d" );
    }
    /* src/mpid/globus/mpid_services.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|connacc|bcast_vct_error_status", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|connacc|bcast_vct_error_status" );
    {
    /* src/mpid/globus/mpid_services.c */
    char s1[] = "pointer1";
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|connacc|bcast_vct_error_status", "**globus|connacc|bcast_vct_error_status %p", s1 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|connacc|bcast_vct_error_status %p" );
    }
    /* src/mpid/globus/mpid_services.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|connacc|bcast_vct_len", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|connacc|bcast_vct_len" );
    {
    /* src/mpid/globus/mpid_services.c */
    char s1[] = "pointer1";
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|connacc|bcast_vct_len", "**globus|connacc|bcast_vct_len %p", s1 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|connacc|bcast_vct_len %p" );
    }
    /* src/mpid/globus/mpid_services.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|connacc|bcast_vct_str", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|connacc|bcast_vct_str" );
    {
    /* src/mpid/globus/mpid_services.c */
    char s1[] = "pointer1";
    char s2[] = "pointer2";
    int i3 = 3;
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|connacc|bcast_vct_str", "**globus|connacc|bcast_vct_str %p %p %d", s1, s2, i3 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|connacc|bcast_vct_str %p %p %d" );
    }
    /* src/mpid/globus/mpid_services.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|connacc|ctxalloc", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|connacc|ctxalloc" );
    {
    /* src/mpid/globus/mpid_services.c */
    char s1[] = "pointer1";
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|connacc|ctxalloc", "**globus|connacc|ctxalloc %p", s1 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|connacc|ctxalloc %p" );
    }
    /* src/mpid/globus/mpid_services.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|connacc|bcast_vct_error_status_recvd", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|connacc|bcast_vct_error_status_recvd" );
    {
    /* src/mpid/globus/mpid_services.c */
    char s1[] = "pointer1";
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|connacc|bcast_vct_error_status_recvd", "**globus|connacc|bcast_vct_error_status_recvd %p", s1 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|connacc|bcast_vct_error_status_recvd %p" );
    }
    /* src/mpid/globus/mpid_services.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|connacc|vcrt_deserialize", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|connacc|vcrt_deserialize" );
    /* src/mpid/globus/mpid_services.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|connacc|port_connect", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|connacc|port_connect" );
    {
    /* src/mpid/globus/mpid_services.c */
    char s1[] = "string1";
    int i2 = 2;
    int i3 = MPI_COMM_WORLD;
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|connacc|port_connect", "**globus|connacc|port_connect %s %i %C", s1, i2, i3 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|connacc|port_connect %s %i %C" );
    }
    {
    /* src/mpid/globus/mpid_services.c */
    char s1[] = "pointer1";
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|connacc|port_vc_send", "**globus|connacc|port_vc_send %p", s1 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|connacc|port_vc_send %p" );
    }
    /* src/mpid/globus/mpid_vc.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|inttostrconv", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|inttostrconv" );
    /* src/mpid/globus/mpid_vc.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|strspace_extract_element", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|strspace_extract_element" );
    {
    /* src/mpid/globus/mpid_vc.c */
    char s1[] = "string1";
    char s2[] = "pointer2";
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|strspace_extract_element", "**globus|strspace_extract_element %s %p", s1, s2 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|strspace_extract_element %s %p" );
    }
    /* src/mpid/globus/mpid_vc.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|strtointconv", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|strtointconv" );
    {
    /* src/mpid/globus/mpid_vc.c */
    char s1[] = "string1";
    char s2[] = "string2";
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|strtointconv", "**globus|strtointconv %s %s", s1, s2 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|strtointconv %s %s" );
    }
    /* src/mpid/globus/mpid_vc.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|pm_get_app_num", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|pm_get_app_num" );
    /* src/mpid/globus/mpid_vc.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm|construct_vc_contact_info", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm|construct_vc_contact_info" );
    {
    /* src/mpid/globus/mpid_vc.c */
    char s1[] = "string1";
    char s2[] = "string2";
    int i3 = 3;
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm|construct_vc_contact_info", "**globus|cm|construct_vc_contact_info %s %s %d", s1, s2, i3 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm|construct_vc_contact_info %s %s %d" );
    }
    /* src/mpid/globus/mpid_vc.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm|select_comm_method", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm|select_comm_method" );
    {
    /* src/mpid/globus/mpid_vc.c */
    char s1[] = "string1";
    char s2[] = "string2";
    int i3 = 3;
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm|select_comm_method", "**globus|cm|select_comm_method %s %s %d", s1, s2, i3 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm|select_comm_method %s %s %d" );
    }
    /* src/mpid/globus/mpid_vc.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm|select_comm_method_none", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm|select_comm_method_none" );
    {
    /* src/mpid/globus/mpid_vc.c */
    char s1[] = "string1";
    int i2 = 2;
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm|select_comm_method_none", "**globus|cm|select_comm_method_none %s %d", s1, i2 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm|select_comm_method_none %s %d" );
    }
    /* src/mpid/globus/mpig_cm_xio_vc.i */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|send_enq_isend", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|send_enq_isend" );
    /* src/mpid/globus/mpig_cm_xio_vc.i */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|send_enq_cancel_send_msg", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|send_enq_cancel_send_msg" );
    /* src/mpid/globus/mpig_cm_xio_vc.i */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cancel_completed_sreq", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cancel_completed_sreq" );
    {
    /* src/mpid/globus/mpig_cm_xio_vc.i */
    int i1 = MPI_REQUEST_NULL;
    char s2[] = "pointer2";
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cancel_completed_sreq", "**globus|cancel_completed_sreq %R %p", i1, s2 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cancel_completed_sreq %R %p" );
    }
    /* src/mpid/globus/mpig_cm_vmpi.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_vmpi|uuid_generate", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_vmpi|uuid_generate" );
    /* src/mpid/globus/mpig_cm_vmpi.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_vmpi|uuid_create", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_vmpi|uuid_create" );
    /* src/mpid/globus/mpig_cm_vmpi.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_vmpi|uuid_parse", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_vmpi|uuid_parse" );
    /* src/mpid/globus/mpig_cm_vmpi.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|vmpi_pe_init", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|vmpi_pe_init" );
    /* src/mpid/globus/mpig_cm_vmpi.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|vmpi_pe_finalize", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|vmpi_pe_finalize" );
    /* src/mpid/globus/mpig_cm_vmpi.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_vmpi|uuid_import", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_vmpi|uuid_import" );
    /* src/mpid/globus/mpig_cm_vmpi.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|vmpi_pe_table_inc_size", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|vmpi_pe_table_inc_size" );
    /* src/mpid/globus/mpig_cm_vmpi.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|vmpi_req_failed", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|vmpi_req_failed" );
    {
    /* src/mpid/globus/mpig_cm_vmpi.c */
    char s1[] = "string1";
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|vmpi_req_failed", "**globus|vmpi_req_failed %s", s1 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|vmpi_req_failed %s" );
    }
    /* src/mpid/globus/mpig_cm_vmpi.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|recvq_unreg_ras", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|recvq_unreg_ras" );
    /* src/mpid/globus/mpig_cm_vmpi.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_vmpi|pe_table_add_req", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_vmpi|pe_table_add_req" );
    {
    /* src/mpid/globus/mpig_cm_vmpi.c */
    int i1 = MPI_REQUEST_NULL;
    char s2[] = "pointer2";
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_vmpi|pe_table_add_req", "**globus|cm_vmpi|pe_table_add_req %R %p", i1, s2 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_vmpi|pe_table_add_req %R %p" );
    }
    /* src/mpid/globus/mpig_cm_vmpi.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_vmpi|localcomm", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_vmpi|localcomm" );
    {
    /* src/mpid/globus/mpig_cm_vmpi.c */
    int i1 = MPI_COMM_WORLD;
    char s2[] = "pointer2";
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_vmpi|localcomm", "**globus|cm_vmpi|localcomm %C %p", i1, s2 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_vmpi|localcomm %C %p" );
    }
    /* src/mpid/globus/mpig_cm_vmpi.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_vmpi|dt_resize_bounds", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_vmpi|dt_resize_bounds" );
    {
    /* src/mpid/globus/mpig_cm_vmpi.c */
    int i1 = MPI_INT;
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_vmpi|dt_resize_bounds", "**globus|cm_vmpi|dt_resize_bounds %D", i1 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_vmpi|dt_resize_bounds %D" );
    }
    /* src/mpid/globus/mpig_cm_xio.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|tcp_buf_size_invalid", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|tcp_buf_size_invalid" );
    {
    /* src/mpid/globus/mpig_cm_xio.c */
    char s1[] = "string1";
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|tcp_buf_size_invalid", "**globus|tcp_buf_size_invalid %s", s1 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|tcp_buf_size_invalid %s" );
    }
    /* src/mpid/globus/mpig_cm_xio.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|tcp_buf_size_neg", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|tcp_buf_size_neg" );
    {
    /* src/mpid/globus/mpig_cm_xio.c */
    char s1[] = "string1";
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|tcp_buf_size_neg", "**globus|tcp_buf_size_neg %s", s1 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|tcp_buf_size_neg %s" );
    }
    /* src/mpid/globus/mpig_cm_xio.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|tcp_buf_size_overflow", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|tcp_buf_size_overflow" );
    {
    /* src/mpid/globus/mpig_cm_xio.c */
    char s1[] = "string1";
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|tcp_buf_size_overflow", "**globus|tcp_buf_size_overflow %s", s1 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|tcp_buf_size_overflow %s" );
    }
    /* src/mpid/globus/mpig_cm_xio.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|rcq_init", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|rcq_init" );
    {
    /* src/mpid/globus/mpig_cm_xio.c */
    char s1[] = "string1";
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|module_activate", "**globus|module_activate %s", s1 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|module_activate %s" );
    }
    /* src/mpid/globus/mpig_cm_xio.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|rcq_finalize", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|rcq_finalize" );
    /* src/mpid/globus/mpig_cm_xio.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|rcq_deq_wait", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|rcq_deq_wait" );
    /* src/mpid/globus/mpig_cm_xio.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|cm_xio|rcq_deq_test", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|cm_xio|rcq_deq_test" );
    /* src/mpid/globus/mpig_pg.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|pg_create", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|pg_create" );
    {
    /* src/mpid/globus/mpig_pg.c */
    char s1[] = "string1";
    int i2 = 2;
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|pg_create", "**globus|pg_create %s %d", s1, i2 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|pg_create %s %d" );
    }
    /* src/mpid/globus/mpig_pg.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|pg|lpid_counter", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|pg|lpid_counter" );
    /* src/mpid/globus/mpid_pt2pt.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|badreqtype", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|badreqtype" );
    {
    /* src/mpid/globus/mpid_pt2pt.c */
    int i1 = 1;
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|badreqtype", "**globus|badreqtype %d", i1 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|badreqtype %d" );
    }
    /* src/mpid/globus/mpig_misc.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|datatype_cmap_to_bc", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|datatype_cmap_to_bc" );
    /* src/mpid/globus/mpig_misc.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|datatype_bc_to_cmap", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**globus|datatype_bc_to_cmap" );
    {
    /* src/mpid/globus/mpig_misc.c */
    char s1[] = "string1";
    int i2 = 2;
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**globus|datatype_bc_to_cmap", "**globus|datatype_cmap %s %d", s1, i2 );
    ChkMsg( err, MPI_ERR_OTHER, "**globus|datatype_cmap %s %d" );
    }
    MPI_Finalize();
    return 0;
}
